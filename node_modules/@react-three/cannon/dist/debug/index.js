import { createContext, useState, useRef, useCallback, useLayoutEffect, useEffect, useMemo, useContext, Suspense } from 'react';
import { useThree, useFrame } from '@react-three/fiber';
import { Vector3, Quaternion as Quaternion$2, Matrix4, InstancedMesh, MeshBasicMaterial, SphereGeometry, BoxGeometry, PlaneGeometry, Mesh, CylinderGeometry, BufferGeometry, Float32BufferAttribute, Scene, Object3D, Euler, MathUtils, DynamicDrawUsage } from 'three';
...
function apply(index, positions, quaternions, object) {
  if (index !== undefined) {
    m.compose(v$1.fromArray(positions, index * 3), q$2.fromArray(quaternions, index * 4), object ? object.scale : s$1);
...
const Provider = _ref => {
  ...
  const [worker] = useState(() => new CannonWorkerAPI({
    allowSleep,
    axisIndex,
    broadphase,
    defaultContactMaterial,
